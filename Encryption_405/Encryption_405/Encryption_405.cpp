...
std::string read_file(const std::string& filename)
{
    ...
    std::ifstream ifs(filename); //to read file
    ...
    file_text.assign((std::istreambuf_iterator<char>(ifs)), (std::istreambuf_iterator<char>())); //reads characters from the object
...
void save_data_file(const std::string& filename, const std::string& student_name, const std::string& key, const std::string& data)
{
    ...
    //  file format
    std::ofstream file(filename);//opened object filename
    if (!file.is_open())
    {
